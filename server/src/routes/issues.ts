  ...
  router.patch("/issues/:id", validate(updateIssueRouteSchema), async (req, res) => {
    ...
    await logActivity(db, {
      ...
      details: {
        ...
        identifier: issue.identifier,
        title: issue.title,
        previousStatus: previous.status ?? existing.status,
        projectId: issue.projectId ?? "",
        goalId: issue.goalId ?? "",
        assigneeAgentId: issue.assigneeAgentId ?? "",
        assigneeAgentName: issue.executionAgentNameKey ?? "",
    ...
    if (reopenRequested && isClosed) {
      ...
      await logActivity(db, {
        ...
        details: {
          id: currentIssue.id,
          status: "todo",
          previousStatus: reopenFromStatus ?? issue.status,
          reopened: true,
          ...
          assigneeAgentName: currentIssue.executionAgentNameKey ?? "",
          executionAgentNameKey: currentIssue.executionAgentNameKey ?? "",
